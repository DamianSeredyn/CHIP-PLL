...
C {lab_wire.sym} 150 180 0 0 {name=p3 sig_type=std_logic lab=gnd!
}
...
footprint=1206
device="ceramic capacitor"}
C {lab_wire.sym} 200 180 0 0 {name=p4 sig_type=std_logic lab=gnd!
}
...
footprint=1206
device="ceramic capacitor"}
C {lab_wire.sym} 250 180 0 0 {name=p5 sig_type=std_logic lab=gnd!
}
...
footprint=1206
device="ceramic capacitor"}
C {lab_wire.sym} 300 180 0 0 {name=p6 sig_type=std_logic lab=gnd!
}
...
footprint=1206
device="ceramic capacitor"}
C {lab_wire.sym} 350 180 0 0 {name=p7 sig_type=std_logic lab=gnd!
}
...
footprint=1206
device="ceramic capacitor"}
C {lab_wire.sym} 410 180 0 0 {name=p9 sig_type=std_logic lab=gnd!
}
...
footprint=1206
device="ceramic capacitor"}
C {lab_wire.sym} 460 180 0 0 {name=p10 sig_type=std_logic lab=gnd!
}
