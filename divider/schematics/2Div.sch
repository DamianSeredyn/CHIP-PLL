...
N -690 -10 -670 -10 {lab=#net2}
N 0 50 10 50 {lab=#net3}
N 10 50 10 70 {lab=#net3}
N -310 70 10 70 {lab=#net3}
N -310 10 -310 70 {lab=#net3}
N -310 10 -300 10 {lab=#net3}
N 0 10 20 10 {lab=vp}
N 0 30 20 30 {lab=gd}
N -340 -10 -300 -10 {lab=div2}
N 370 50 380 50 {lab=#net4}
N 380 50 380 70 {lab=#net4}
N 60 70 380 70 {lab=#net4}
N 60 10 60 70 {lab=#net4}
N 60 10 70 10 {lab=#net4}
...
N 740 50 750 50 {lab=#net5}
N 750 50 750 70 {lab=#net5}
N 430 70 750 70 {lab=#net5}
N 430 10 430 70 {lab=#net5}
N 430 10 440 10 {lab=#net5}
N 740 10 760 10 {lab=vp}
N 740 30 760 30 {lab=gd}
N 400 -10 440 -10 {lab=#net6}
N 400 -20 400 -10 {lab=#net6}
N 370 -10 400 -10 {lab=#net6}
N 740 -10 760 -10 {lab=div16}
N 760 -20 760 -10 {lab=div16}
N -370 220 -360 220 {lab=#net7}
N -360 220 -360 240 {lab=#net7}
N -680 240 -360 240 {lab=#net7}
N -680 180 -680 240 {lab=#net7}
N -680 180 -670 180 {lab=#net7}
N -370 180 -350 180 {lab=vp}
N -370 200 -350 200 {lab=gd}
N -710 160 -670 160 {lab=div16}
N 0 220 10 220 {lab=#net8}
N 10 220 10 240 {lab=#net8}
N -310 240 10 240 {lab=#net8}
N -310 180 -310 240 {lab=#net8}
N -310 180 -300 180 {lab=#net8}
...
N 370 220 380 220 {lab=#net9}
N 380 220 380 240 {lab=#net9}
N 60 240 380 240 {lab=#net9}
N 60 180 60 240 {lab=#net9}
N 60 180 70 180 {lab=#net9}
...
C {lab_pin.sym} 390 -20 1 0 {name=p35 sig_type=std_logic lab=div8}
