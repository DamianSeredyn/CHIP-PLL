...
N -190 100 -150 100 {lab=#net5}
N -190 120 -150 120 {lab=d3}
N 310 100 350 100 {lab=#net6}
...
N -190 230 -150 230 {lab=#net9}
N -190 250 -150 250 {lab=d7}
N 310 230 350 230 {lab=#net10}
...
N -190 360 -150 360 {lab=#net13}
N -190 380 -150 380 {lab=d11}
N 310 360 350 360 {lab=#net14}
N 150 360 230 360 {lab=d12}
N 230 360 230 380 {lab=d12}
N 230 380 350 380 {lab=d12}
N 230 340 230 360 {lab=d12}
N 650 380 670 380 {lab=GND}
N 650 400 670 400 {lab=VP}
N 650 360 730 360 {lab=d13}
N 730 340 730 360 {lab=d13}
...
C {opin.sym} -190 120 2 0 {name=p18 lab=d3
}
...
C {opin.sym} -190 250 2 0 {name=p51 lab=d7
}
C {/foss/designs/CHIP-PLL/divider/d_flip_flop.sym} 0 390 0 0 {name=x13}
C {opin.sym} 230 340 3 0 {name=p53 lab=d12}
C {/foss/designs/CHIP-PLL/divider/d_flip_flop.sym} 500 390 0 0 {name=x14}
C {opin.sym} 730 340 3 0 {name=p58 lab=d13}
C {opin.sym} -190 380 2 0 {name=p68 lab=d11
}
...
C {lab_pin.sym} 670 380 2 0 {name=p32 sig_type=std_logic lab=GND}
C {lab_pin.sym} 670 400 2 0 {name=p34 sig_type=std_logic lab=VP}
