...
N 730 -200 730 -140 {lab=#net1}
N 1050 -140 1170 -140 {lab=#net2}
N 730 -140 730 -70 {lab=#net1}
...
N 890 -520 1050 -520 {lab=vp}
N 1050 -520 1050 -390 {lab=vp}
N 890 -520 890 -390 {lab=vp}
N 850 -560 1010 -560 {lab=chwcto}
N 1010 -560 1010 -390 {lab=chwcto}
N 850 -560 850 -390 {lab=chwcto}
N 1010 -140 1010 -40 {lab=#net3}
N 890 -140 890 -70 {lab=#net3}
N 850 -140 850 -40 {lab=#net1}
N 890 -140 1010 -140 {lab=#net3}
N 890 -200 890 -140 {lab=#net3}
N 1010 -230 1010 -140 {lab=#net3}
N 1050 -140 1050 -70 {lab=#net2}
N 890 -360 890 -230 {lab=4up}
N 1050 -360 1050 -230 {lab=5up}
N 890 -40 890 80 {lab=4dn}
N 1050 -40 1050 80 {lab=5dn}
N 850 180 1010 180 {lab=in}
N 1010 110 1010 180 {lab=in}
N 850 110 850 180 {lab=in}
N 890 240 1050 240 {lab=gnd}
N 890 110 890 240 {lab=gnd}
N 1050 110 1050 240 {lab=gnd}
N 690 -560 850 -560 {lab=chwcto}
N 730 -520 890 -520 {lab=vp}
N 730 -140 850 -140 {lab=#net1}
N 850 -230 850 -140 {lab=#net1}
N 1050 -200 1050 -140 {lab=#net2}
N 690 180 850 180 {lab=in}
N 730 240 890 240 {lab=gnd}
N 1370 -140 1420 -140 {lab=out}
N 1370 -520 1370 -390 {lab=vp}
N 1210 -520 1210 -390 {lab=vp}
N 1170 -560 1330 -560 {lab=chwcto}
N 1330 -560 1330 -390 {lab=chwcto}
N 1170 -560 1170 -390 {lab=chwcto}
N 1330 -140 1330 -40 {lab=4-5}
N 1210 -140 1210 -70 {lab=4-5}
N 1210 -140 1330 -140 {lab=4-5}
N 1210 -200 1210 -140 {lab=4-5}
N 1330 -230 1330 -140 {lab=4-5}
N 1370 -140 1370 -70 {lab=out}
N 1210 -360 1210 -230 {lab=4up}
N 1370 -360 1370 -230 {lab=5up}
N 1210 -40 1210 80 {lab=4dn}
N 1370 -40 1370 80 {lab=5dn}
N 1170 180 1330 180 {lab=in}
N 1330 110 1330 180 {lab=in}
N 1170 110 1170 180 {lab=in}
N 1210 240 1370 240 {lab=gnd}
N 1210 110 1210 240 {lab=gnd}
N 1370 110 1370 240 {lab=gnd}
N 1010 -560 1170 -560 {lab=chwcto}
N 1170 -140 1170 -40 {lab=#net2}
N 1370 -160 1370 -140 {lab=out}
N 1010 180 1170 180 {lab=in}
N 1050 240 1210 240 {lab=gnd}
N 1210 -520 1370 -520 {lab=vp}
N 1050 -520 1210 -520 {lab=vp}
N 1170 -230 1170 -140 {lab=#net2}
N -40 -160 1370 -160 {lab=out}
N 1370 -200 1370 -160 {lab=out}
...
C {opin.sym} 1420 -140 0 0 {name=p4 lab=out}
...
C {sg13g2_pr/sg13_lv_pmos.sym} 870 -390 0 0 {name=M23
l=0.18u
w=1.21u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1030 -390 0 0 {name=M24
l=0.18u
w=1.21u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 870 -230 0 0 {name=M25
l=0.18u
w=1.2u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1030 -230 0 0 {name=M26
l=0.18u
w=1.2u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 870 -40 0 0 {name=M27
l=0.18u
w=0.4u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1030 -40 0 0 {name=M28
l=0.18u
w=0.4u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 870 110 0 0 {name=M29
l=0.420u
w=0.405u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1030 110 0 0 {name=M30
l=0.420u
w=0.405u
ng=1
m=1
...
C {lab_wire.sym} 890 -310 0 0 {name=p21 sig_type=std_logic lab=4up
}
C {lab_wire.sym} 1050 -310 0 0 {name=p22 sig_type=std_logic lab=5up
}
C {lab_wire.sym} 890 30 0 0 {name=p23 sig_type=std_logic lab=4dn}
C {lab_wire.sym} 1050 30 0 0 {name=p24 sig_type=std_logic lab=5dn}
C {sg13g2_pr/sg13_lv_pmos.sym} 1190 -390 0 0 {name=M31
l=0.18u
w=1.21u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1350 -390 0 0 {name=M32
l=0.18u
w=1.21u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1190 -230 0 0 {name=M33
l=0.18u
w=1.2u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_pmos.sym} 1350 -230 0 0 {name=M34
l=0.18u
w=1.2u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1190 -40 0 0 {name=M35
l=0.18u
w=0.4u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1350 -40 0 0 {name=M36
l=0.18u
w=0.4u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1190 110 0 0 {name=M37
l=0.420u
w=0.405u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} 1350 110 0 0 {name=M38
l=0.420u
w=0.405u
ng=1
m=1
...
C {lab_wire.sym} 1210 -310 0 0 {name=p26 sig_type=std_logic lab=4up
}
C {lab_wire.sym} 1370 -310 0 0 {name=p27 sig_type=std_logic lab=5up
}
C {lab_wire.sym} 1210 30 0 0 {name=p28 sig_type=std_logic lab=4dn}
C {lab_wire.sym} 1370 30 0 0 {name=p29 sig_type=std_logic lab=5dn}
