...
C {vsource.sym} -160 220 0 0 {name=V1 value="PWL(0 0.775 3n 0.8 6n 0.775 r=0)" savecurrent=false}
...
C {/foss/designs/CHIP-PLL/vco/vco_cell/vco_core.sym} 100 -10 0 0 {name=x2}
