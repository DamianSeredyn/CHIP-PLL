...
N 2560 -60 2700 -60 {lab=out}
N 2480 60 2480 80 {lab=gd}
N 200 180 910 180 {lab=cvco}
N 2040 80 2050 80 {lab=#net1}
N 2050 80 2050 100 {lab=#net1}
N 1730 100 2050 100 {lab=#net1}
N 1730 40 1730 100 {lab=#net1}
N 1730 40 1740 40 {lab=#net1}
N 2040 40 2060 40 {lab=vp}
N 2040 60 2060 60 {lab=gd}
N 2040 20 2110 20 {lab=#net2}
...
N 2320 20 2390 20 {lab=vco_out_buffered}
N 2210 -80 2210 -30 {lab=vp}
N 2210 70 2210 110 {lab=gd}
N 2450 -130 2450 -100 {lab=vp}
N 2500 -130 2500 -100 {lab=vph}
...
C {lab_wire.sym} 2480 80 0 0 {name=p13 sig_type=std_logic lab=gd}
...
C {opin.sym} 2700 -60 0 0 {name=p20 lab=out}
...
C {lab_wire.sym} 2350 20 0 0 {name=p24 sig_type=std_logic lab=vco_out_buffered}
C {lab_pin.sym} 2060 60 2 0 {name=p41 sig_type=std_logic lab=gd}
C {lab_pin.sym} 2060 40 2 0 {name=p42 sig_type=std_logic lab=vp}
...
C {/foss/designs/CHIP-PLL/schematics/buf/buf.sym} 2210 20 0 0 {name=xBUF}
...
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/d_flip_flop.sym} 1890 50 0 0 {name=x5}
C {/foss/designs/CHIP-PLL/schematics/misc/level_shifter.sym} 2540 -40 0 0 {name=xLS}
...
C {lab_pin.sym} 2210 110 2 0 {name=p9 sig_type=std_logic lab=gd}
C {lab_pin.sym} 2210 -80 2 0 {name=p10 sig_type=std_logic lab=vp}
C {lab_pin.sym} 2450 -130 2 0 {name=p11 sig_type=std_logic lab=vp}
C {lab_pin.sym} 2500 -130 2 0 {name=p12 sig_type=std_logic lab=vph}
