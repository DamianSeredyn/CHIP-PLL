...
N 1180 180 1880 180 {lab=vco_out_buffered}
...
C {lab_wire.sym} 1130 0 0 0 {name=p16 sig_type=std_logic lab=vout}
...
C {lab_wire.sym} 1660 0 0 0 {name=p29 sig_type=std_logic lab=vco_out_prebuff}
...
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/d_flip_flop.sym} 2120 30 0 0 {name=x5}
C {/foss/designs/CHIP-PLL/schematics/misc/level_shifter.sym} 2770 -60 0 0 {name=xLS}
...
C {lab_pin.sym} 2680 -150 2 0 {name=p11 sig_type=std_logic lab=vp}
C {lab_pin.sym} 2730 -150 2 0 {name=p12 sig_type=std_logic lab=vph}
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/inverter_x2.sym} 2390 0 0 0 {name=x1}
C {lab_wire.sym} 2380 -50 0 0 {name=p50 sig_type=std_logic lab=vp}
C {lab_wire.sym} 2380 50 0 0 {name=p51 sig_type=std_logic lab=gd}
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/inverter_x4.sym} 2510 0 0 0 {name=x3}
C {lab_wire.sym} 2510 -50 0 0 {name=p24 sig_type=std_logic lab=vp}
C {lab_wire.sym} 2510 50 0 0 {name=p49 sig_type=std_logic lab=gd}
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/inverter_x4.sym} 1690 0 0 0 {name=x4}
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/inverter_x8.sym} 1800 0 0 0 {name=x6}
C {lab_wire.sym} 1730 180 0 0 {name=p52 sig_type=std_logic lab=vco_out_buffered}
C {lab_wire.sym} 1690 -60 0 0 {name=p53 sig_type=std_logic lab=vp}
C {lab_wire.sym} 1790 -60 0 0 {name=p54 sig_type=std_logic lab=vp}
