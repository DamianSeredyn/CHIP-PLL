...
N 1580 30 1670 30 {lab=vco_out_prebuff}
N 1670 20 1670 30 {lab=vco_out_prebuff}
N 1580 10 1630 10 {lab=vp}
N 1580 50 1630 50 {lab=gd}
N 1700 190 1710 190 {lab=vco_out_buffered}
N 1700 130 1700 190 {lab=vco_out_buffered}
N 1700 130 2060 130 {lab=vco_out_buffered}
N 1670 30 1670 180 {lab=vco_out_prebuff}
...
C {CHIP-PLL/schematics/PFD/PFD_cell.sym} 430 10 0 0 {name=x7}
C {CHIP-PLL/schematics/charge_pump/charge_pump_cell.sym} 780 10 0 0 {name=x8}
C {CHIP-PLL/schematics/misc/RC_filter.sym} 1160 20 0 0 {name=x9}
C {CHIP-PLL/schematics/misc/buffer_hv.sym} 210 -20 0 0 {name=x2}
C {CHIP-PLL/schematics/misc/level_shifter.sym} 2230 130 0 0 {name=x1}
C {CHIP-PLL/schematics/buf/buf.sym} 1840 20 0 0 {name=x3}
C {CHIP-PLL/schematics/divider/schematics/Divider_top.sym} 1030 180 0 0 {name=x4}
...
C {CHIP-PLL/schematics/divider/schematics/d_flip_flop.sym} 1860 220 0 0 {name=x5}
...
C {CHIP-PLL/schematics/vco/vco_cell/vco_cell.sym} 1430 30 0 0 {name=x6}
C {lab_wire.sym} 1620 10 0 0 {name=p25 sig_type=std_logic lab=vp}
C {lab_wire.sym} 1620 50 0 0 {name=p28 sig_type=std_logic lab=gd}
