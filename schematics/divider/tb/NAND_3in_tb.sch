...
"}
C {devices/code_shown.sym} -270 -850 0 0 {name=NGSPICE only_toplevel=false
value="
.param temp=27
.control
...
C {vsource.sym} -510 -240 0 0 {name=V2 value="PULSE(0 1.2 0 10p 10p 3.335n 6.67n)" savecurrent=false}
...
C {vsource.sym} -500 -100 0 0 {name=V3 value="PULSE(0 1.2 2n 10p 10p 3.335n 6.67n)" savecurrent=false}
C {lab_wire.sym} -500 -150 0 0 {name=p1 sig_type=std_logic lab=b
}
C {lab_wire.sym} -500 -60 0 0 {name=p4 sig_type=std_logic lab=gnd!
}
C {vsource.sym} -510 40 0 0 {name=V4 value="PULSE(0 1.2 1n 10p 10p 3.335n 6.67n)" savecurrent=false}
