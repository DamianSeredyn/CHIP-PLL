...
N 750 -420 780 -420 {lab=#net2}
N 750 -270 780 -270 {lab=#net3}
N 750 -340 750 -270 {lab=#net3}
N 680 -270 750 -270 {lab=#net3}
N 750 -420 750 -400 {lab=#net2}
N 690 -420 750 -420 {lab=#net2}
N 360 -310 380 -310 {lab=#net2}
N 360 -340 360 -310 {lab=#net2}
N 360 -440 390 -440 {lab=#net3}
N 360 -440 360 -400 {lab=#net3}
N 360 -400 750 -340 {lab=#net3}
N 360 -340 750 -400 {lab=#net2}
N 200 -420 280 -420 {lab=#net1}
N 280 -460 280 -420 {lab=#net1}
N 280 -460 390 -460 {lab=#net1}
N -160 -460 -130 -460 {lab=#net4}
N -160 -480 -160 -460 {lab=#net4}
N 180 -570 230 -570 {lab=#net4}
N 230 -570 230 -540 {lab=#net4}
N -160 -480 230 -540 {lab=#net4}
N 280 -500 280 -460 {lab=#net1}
N -160 -590 -120 -590 {lab=#net1}
N -160 -590 -160 -540 {lab=#net1}
N -160 -540 280 -500 {lab=#net1}
N 170 -270 250 -270 {lab=#net5}
N -150 -270 -130 -270 {lab=#net6}
N -150 -270 -150 -240 {lab=#net6}
N -150 -130 -130 -130 {lab=#net5}
N -150 -160 -150 -130 {lab=#net5}
N 170 -90 250 -90 {lab=#net6}
N 250 -160 250 -90 {lab=#net6}
N 250 -270 250 -240 {lab=#net5}
N -150 -160 250 -240 {lab=#net5}
N -150 -240 250 -160 {lab=#net6}
N 250 -290 380 -290 {lab=#net5}
N 250 -290 250 -270 {lab=#net5}
N -200 -610 -120 -610 {lab=#net6}
N -200 -610 -200 -270 {lab=#net6}
N -200 -270 -150 -270 {lab=#net6}
N -240 -290 -130 -290 {lab=clk}
N -240 -440 -240 -290 {lab=clk}
N -240 -440 -130 -440 {lab=clk}
N -230 -110 -130 -110 {lab=d}
C {/foss/designs/CHIP-PLL/divider/NAND_3in.sym} 20 -290 0 0 {name=x1}
...
C {/foss/designs/CHIP-PLL/divider/NAND_2in.sym} 20 -440 0 0 {name=x2}
...
C {/foss/designs/CHIP-PLL/divider/NAND_2in.sym} 30 -590 0 0 {name=x3}
...
C {/foss/designs/CHIP-PLL/divider/NAND_2in.sym} 20 -110 0 0 {name=x4}
...
C {/foss/designs/CHIP-PLL/divider/NAND_2in.sym} 530 -290 0 0 {name=x5}
...
C {/foss/designs/CHIP-PLL/divider/NAND_2in.sym} 540 -440 0 0 {name=x6}
