...
F {}
E {}
N -970 -290 -950 -290 {lab=gd}
N -970 -270 -950 -270 {lab=vp}
N -970 -250 -950 -250 {lab=out}
N -970 -230 -950 -230 {lab=in1}
N -970 -210 -950 -210 {lab=in2}
N -970 -190 -950 -190 {lab=in3}
N -970 -170 -950 -170 {lab=in4}
N -970 -130 -950 -130 {lab=in6}
N -970 -110 -950 -110 {lab=in7}
N -970 -90 -950 -90 {lab=in8}
N 290 -260 290 -240 {lab=en8_}
N 290 -180 290 -160 {lab=en8}
N 330 -180 330 -170 {lab=gd}
N 330 -250 330 -240 {lab=vp}
N 350 -210 370 -210 {lab=out_unb}
N 290 -60 290 -40 {lab=en7_}
N 290 20 290 40 {lab=en7}
N 330 20 330 30 {lab=gd}
N 330 -50 330 -40 {lab=vp}
N 160 -10 170 -10 {lab=in7}
N 350 -10 370 -10 {lab=out_unb}
N -970 -150 -950 -150 {lab=in5}
N 290 140 290 160 {lab=en6_}
N 290 220 290 240 {lab=en6}
N 330 220 330 230 {lab=gd}
...
N 160 390 170 390 {lab=in5}
N 350 390 370 390 {lab=out_unb}
N 690 -260 690 -240 {lab=en4_}
N 690 -180 690 -160 {lab=en4}
N 730 -180 730 -170 {lab=gd}
N 730 -250 730 -240 {lab=vp}
N 750 -210 770 -210 {lab=out_unb}
N 690 -60 690 -40 {lab=en3_}
N 690 20 690 40 {lab=en3}
N 730 20 730 30 {lab=gd}
N 730 -50 730 -40 {lab=vp}
N 560 -10 570 -10 {lab=in3}
N 750 -10 770 -10 {lab=out_unb}
N 690 140 690 160 {lab=en2_}
N 690 220 690 240 {lab=en2}
N 730 220 730 230 {lab=gd}
N 730 150 730 160 {lab=vp}
N 750 190 770 190 {lab=out_unb}
N 690 340 690 360 {lab=en1_}
N 690 420 690 440 {lab=en1}
N 730 420 730 430 {lab=gd}
N 730 350 730 360 {lab=vp}
N 750 390 770 390 {lab=out_unb}
N -710 -320 -700 -320 {lab=vp}
N -710 -320 -710 -300 {lab=vp}
N -710 -220 -700 -220 {lab=gd}
N -710 -240 -710 -220 {lab=gd}
N -740 -270 -730 -270 {lab=A0}
N -710 -150 -700 -150 {lab=vp}
N -710 -150 -710 -130 {lab=vp}
N -710 -50 -700 -50 {lab=gd}
N -710 -70 -710 -50 {lab=gd}
N -740 -100 -730 -100 {lab=A1}
N -710 10 -700 10 {lab=vp}
N -710 10 -710 30 {lab=vp}
N -710 110 -700 110 {lab=gd}
N -710 90 -710 110 {lab=gd}
N -740 60 -730 60 {lab=A2}
N -170 -270 -160 -270 {lab=vp}
N -170 -250 -160 -250 {lab=gd}
...
N -550 -130 -550 -100 {lab=#net2}
N -660 60 -530 60 {lab=#net3}
N -530 30 -530 60 {lab=#net3}
N -570 -230 -470 -230 {lab=#net1}
N -570 -270 -570 -230 {lab=#net1}
N -550 -250 -470 -250 {lab=#net2}
N -530 -270 -470 -270 {lab=#net3}
N -570 10 -470 10 {lab=#net1}
N -570 -230 -570 10 {lab=#net1}
N -570 290 -470 290 {lab=#net1}
N -570 10 -570 290 {lab=#net1}
N -570 570 -470 570 {lab=#net1}
N -570 290 -570 570 {lab=#net1}
N -550 -130 -470 -130 {lab=#net2}
N -550 -250 -550 -130 {lab=#net2}
N -550 430 -470 430 {lab=#net2}
N -550 310 -550 430 {lab=#net2}
N -550 310 -470 310 {lab=#net2}
N -550 -100 -550 310 {lab=#net2}
N -530 -110 -470 -110 {lab=#net3}
N -530 -270 -530 -110 {lab=#net3}
N -530 30 -470 30 {lab=#net3}
N -530 -110 -530 30 {lab=#net3}
N -530 150 -470 150 {lab=#net3}
N -530 60 -530 150 {lab=#net3}
N -590 710 -470 710 {lab=A2}
N -590 590 -590 710 {lab=A2}
N -590 590 -470 590 {lab=A2}
N -590 450 -590 590 {lab=A2}
N -590 450 -470 450 {lab=A2}
N -590 330 -590 450 {lab=A2}
N -590 330 -470 330 {lab=A2}
N -590 130 -590 330 {lab=A2}
N -610 730 -470 730 {lab=A1}
N -610 610 -610 730 {lab=A1}
N -610 610 -470 610 {lab=A1}
N -610 170 -610 610 {lab=A1}
N -610 50 -470 50 {lab=A1}
N -610 -30 -610 50 {lab=A1}
N -610 170 -470 170 {lab=A1}
N -610 50 -610 170 {lab=A1}
N -630 -90 -470 -90 {lab=A0}
N -630 -200 -630 -90 {lab=A0}
N -630 190 -470 190 {lab=A0}
N -630 -90 -630 190 {lab=A0}
N -630 470 -470 470 {lab=A0}
N -630 190 -630 470 {lab=A0}
N -630 750 -470 750 {lab=A0}
N 240 -210 270 -210 {lab=#net4}
N 190 -250 190 -240 {lab=vp}
N 190 -180 190 -170 {lab=gd}
N 150 -210 170 -210 {lab=in8}
N 240 -10 270 -10 {lab=#net5}
N 190 -50 190 -40 {lab=vp}
N 190 20 190 30 {lab=gd}
N 240 190 270 190 {lab=#net6}
N 190 150 190 160 {lab=vp}
N 190 220 190 230 {lab=gd}
N 240 390 270 390 {lab=#net7}
N 190 350 190 360 {lab=vp}
N 190 420 190 430 {lab=gd}
N 560 190 570 190 {lab=in2}
N 560 390 570 390 {lab=in1}
N 640 -210 670 -210 {lab=#net8}
N 590 -250 590 -240 {lab=vp}
N 590 -180 590 -170 {lab=gd}
N 550 -210 570 -210 {lab=in4}
N 640 -10 670 -10 {lab=#net9}
N 590 -50 590 -40 {lab=vp}
N 590 20 590 30 {lab=gd}
N 640 190 670 190 {lab=#net10}
N 590 150 590 160 {lab=vp}
N 590 220 590 230 {lab=gd}
N 640 390 670 390 {lab=#net11}
N 590 350 590 360 {lab=vp}
N 590 420 590 430 {lab=gd}
N 340 -430 340 -420 {lab=vp}
...
C {lab_pin.sym} -950 -270 2 0 {name=p6 sig_type=std_logic lab=vp}
C {opin.sym} -970 -250 2 0 {name=p2 lab=out}
C {lab_pin.sym} -950 -250 2 0 {name=p3 sig_type=std_logic lab=out}
C {ipin.sym} -970 -230 2 1 {name=p7 lab=in1}
C {lab_pin.sym} -950 -230 2 0 {name=p8 sig_type=std_logic lab=in1}
C {ipin.sym} -970 -210 2 1 {name=p9 lab=in2}
C {lab_pin.sym} -950 -210 2 0 {name=p10 sig_type=std_logic lab=in2}
C {ipin.sym} -970 -190 2 1 {name=p11 lab=in3}
C {lab_pin.sym} -950 -190 2 0 {name=p12 sig_type=std_logic lab=in3}
C {ipin.sym} -970 -170 2 1 {name=p13 lab=in4}
C {lab_pin.sym} -950 -170 2 0 {name=p14 sig_type=std_logic lab=in4}
C {ipin.sym} -970 -150 2 1 {name=p15 lab=in5}
C {lab_pin.sym} -950 -150 2 0 {name=p16 sig_type=std_logic lab=in5}
C {ipin.sym} -970 -130 2 1 {name=p17 lab=in6}
C {lab_pin.sym} -950 -130 2 0 {name=p18 sig_type=std_logic lab=in6}
C {ipin.sym} -970 -110 2 1 {name=p19 lab=in7}
C {lab_pin.sym} -950 -110 2 0 {name=p20 sig_type=std_logic lab=in7}
C {ipin.sym} -970 -90 2 1 {name=p21 lab=in8}
C {lab_pin.sym} -950 -90 2 0 {name=p22 sig_type=std_logic lab=in8}
C {lab_pin.sym} 330 -170 3 0 {name=p23 sig_type=std_logic lab=gd}
C {lab_pin.sym} 290 -260 1 0 {name=p25 sig_type=std_logic lab=en8_}
...
C {lab_pin.sym} 730 -50 1 0 {name=p42 sig_type=std_logic lab=vp}
C {lab_pin.sym} 330 150 1 0 {name=p48 sig_type=std_logic lab=vp}
C {lab_pin.sym} 730 150 1 0 {name=p54 sig_type=std_logic lab=vp}
C {lab_pin.sym} 330 350 1 0 {name=p60 sig_type=std_logic lab=vp}
