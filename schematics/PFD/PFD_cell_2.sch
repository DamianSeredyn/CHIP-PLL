...
N 820 -170 820 -160 {lab=DOWN}
N 820 -170 850 -170 {lab=DOWN}
...
C {lab_wire.sym} 350 60 0 0 {name=p33 sig_type=std_logic lab=pre_up}
...
C {opin.sym} 780 310 0 0 {name=p55 lab=UP
}
C {opin.sym} 850 -170 0 0 {name=p3 lab=DOWN
}
