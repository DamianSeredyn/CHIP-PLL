...
N 620 130 620 170 {lab=vp}
N 640 130 640 170 {lab=clk}
N 620 230 620 270 {lab=gd}
N 640 230 640 270 {lab=clk_n}
N 90 310 90 350 {lab=#net1}
N -10 280 -10 320 {lab=vp}
N -10 380 -10 420 {lab=gd}
N 10 280 10 320 {lab=clk_n}
N -40 -70 -0 -70 {lab=1}
N 50 350 90 350 {lab=#net1}
N 830 -90 890 -90 {lab=vp}
N 130 310 130 350 {lab=vp}
N 830 -70 890 -70 {lab=gd}
N 110 310 110 350 {lab=gd}
...
N 860 -50 1030 -50 {lab=Q}
N 860 50 890 50 {lab=Q}
N 860 -50 860 50 {lab=Q}
N 830 -50 860 -50 {lab=Q}
...
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/inverter_x8.sym} 30 -70 0 0 {name=x2}
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/NOR_2in.sym} 110 160 1 0 {name=x3}
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/NOR_2in.sym} 680 -70 0 0 {name=x5}
C {opin.sym} 1030 -50 0 0 {name=p2 lab=Q}
...
C {lab_wire.sym} 890 -90 0 0 {name=p8 sig_type=std_logic lab=vp}
C {lab_wire.sym} 130 350 0 0 {name=p9 sig_type=std_logic lab=vp}
C {lab_wire.sym} -10 280 0 0 {name=p10 sig_type=std_logic lab=vp}
C {lab_wire.sym} 620 130 0 0 {name=p11 sig_type=std_logic lab=vp}
C {/foss/designs/CHIP-PLL/schematics/divider/schematics/inverter_x8.sym} 100 -300 0 0 {name=x9}
...
C {lab_wire.sym} 110 350 0 0 {name=p15 sig_type=std_logic lab=gd}
C {lab_wire.sym} -10 420 0 0 {name=p16 sig_type=std_logic lab=gd}
...
C {lab_wire.sym} 890 -70 0 0 {name=p21 sig_type=std_logic lab=gd}
C {lab_wire.sym} 620 270 0 0 {name=p23 sig_type=std_logic lab=gd}
...
C {lab_wire.sym} 10 280 0 1 {name=p29 sig_type=std_logic lab=clk_n}
C {lab_wire.sym} 640 270 0 1 {name=p30 sig_type=std_logic lab=clk_n}
...
C {lab_wire.sym} 640 130 0 1 {name=p33 sig_type=std_logic lab=clk}
