...
N 460 -700 460 -640 {lab=iref}
N 620 -660 620 -640 {lab=#net3}
N 460 -580 460 -520 {lab=#net4}
N 520 -750 580 -750 {lab=iref}
N 560 -610 580 -610 {lab=#net3}
N 460 -700 520 -700 {lab=iref}
N 460 -720 460 -700 {lab=iref}
N 520 -750 520 -700 {lab=iref}
N 500 -750 520 -750 {lab=iref}
...
C {lab_pin.sym} 450 -750 0 0 {name=p1 sig_type=std_logic lab=vp}
C {lab_pin.sym} 630 -750 0 1 {name=p2 sig_type=std_logic lab=vp}
C {lab_pin.sym} 630 -610 0 1 {name=p3 sig_type=std_logic lab=gd}
C {lab_pin.sym} 450 -610 0 0 {name=p5 sig_type=std_logic lab=gd}
...
C {lab_pin.sym} 520 -700 0 1 {name=p15 sig_type=std_logic lab=iref}
